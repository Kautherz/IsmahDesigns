class Inventory {
    constructor() {
        this.products = {
            123456: setItem(
                ...
                "Men",
                10.99,
                "images/arbaeen_design2.png",
                "images/arbaeen_design1.png"
            ),
            333333: setItem(
                "Item 3",
                "Hoodies and Sweatshirts",
                "Kids",
                25.99,
                "images/muharram_5front.png",
                "images/muharram_5back.png"
            ),
            444444: setItem(
                "Item 4",
                "Hoodies and Sweatshirts",
                "Kids",
                30.99,
                "images/muharram_4front.png",
                "images/muharram_4back.png"
            ),
            999999: setItem(
                "Item 5",
                "Longsleeve T-Shirts",
    ...
    getGenderDictionary(gender, type) {
        ...
        if (gender == "Men" || gender == "Women" || gender == "Kids") {
            if (
                ...
                type == "Longsleeve T-Shirts" ||
                type == "T-Shirts"
            ) {
                var i = 0;
                while (i < num_products) {
                    if (
                        this.products[keys[i]].gender == gender &&
                        this.products[keys[i]].type == type
                    ) {
    ...
    getTotalPrice(bag) {
        ...
        for (var i = 0; i < num_items; i++) {
            ...
            total =
                parseFloat(total) + parseFloat(price) * parseFloat(quantity);
        }
