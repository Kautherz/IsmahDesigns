const renderProducts = async function () {
    ...
    var link = "";
    if (type) {
        link = `https://afternoon-cliffs-47006.herokuapp.com/products?gender=${gender}&type=${type}`;
    } else {
        link = `https://afternoon-cliffs-47006.herokuapp.com/products?gender=${gender}`;
    }
            ...
            <div class="product-grid2">
                <div class="product-image2">
                    <a href="item.html?product_id=${keys[item]}">
                        <img class="pic-1" id="pic-1" src="${
                            products[keys[item]].pictures[0]
                        }">
                        <img class="pic-2" src="${
                            products[keys[item]].pictures[1]
                        }">
                    </a>
                </div>
                <div class="product-content">
                    <h3 class="title"><a href="item.html?product_id=${
                        keys[item]
                    }">${products[keys[item]].name}</a></h3>
