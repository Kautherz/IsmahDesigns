const renderProductPage = async function () {
    ...
    const response = await fetch(`https://afternoon-cliffs-47006.herokuapp.com/product?productID=${product_id}`);
    ...
    if (product_data.success) {
        ...
        document.getElementById(
            "breadcrumb-list"
        ).innerHTML = `<ol class="breadcrumb-list" id= "breadcrumb-list">
